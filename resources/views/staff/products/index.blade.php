...
<div class="flex justify-between items-center mb-6">
    <div>
        ...
        <p class="text-gray-600">Manage all products in inventory</p>
    </div>
    ...
    <table class="w-full">
        ...
        <tbody>
            ...
            <tr class="border-b hover:bg-gray-50">
                ...
                <td class="px-6 py-4 text-sm">
                    <a href="{{ route('staff.products.edit', $product) }}" class="text-blue-600 hover:text-blue-800 mr-2">Edit</a>
                    <a href="{{ route('staff.products.show', $product) }}" class="text-green-600 hover:text-green-800 mr-2">View</a>
                    <form action="{{ route('staff.products.destroy', $product) }}" method="POST" class="inline"

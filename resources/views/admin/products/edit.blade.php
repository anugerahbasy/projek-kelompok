    ...
    <form action="{{ route('admin.products.update', $product) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <textarea name="description" rows="3" 
                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">{{ old('description', $product->description) }}</textarea>
        </div>
